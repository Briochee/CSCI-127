...
#Date: 02-28-2023
#Program Description: changes elevations to colors
    ...
    for col in range(mapShape[1]):
        if elevations[row,col] <= 0:
           ...
           floodMap[row,col,2] = 1.0     #Set the blue channel to 100%
            ...
            floodMap[row,col,1] = color1
        elif elevations[row,col] > 6 and elevations[row,col] <= 13:
            floodMap[row,col,0:3] = 0.25
        elif elevations[row,col] >13 and elevations[row,col] <= 20:
            floodMap[row,col,0:3] = 0.75
